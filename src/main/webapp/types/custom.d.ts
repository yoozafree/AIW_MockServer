...
declare module 'yup' {
  ...
  interface ObjectSchema<TIn extends yup.Maybe<AnyObject>, TContext = yup.AnyObject, TDefault = any, TFlags extends yup.Flags = ''> extends yup.Schema<MakeKeysOptional<TIn>, TContext, TDefault, TFlags> {
    emptyToNull(msg?: yup.Message): yup.ObjectSchema<TIn | null, TContext, TDefault, TFlags>;
  }
}
