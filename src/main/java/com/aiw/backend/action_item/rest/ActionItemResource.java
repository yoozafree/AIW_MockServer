package com.aiw.backend.action_item.rest;

import com.aiw.backend.action_item.model.ActionItemDTO;
import com.aiw.backend.action_item.service.ActionItemService;
...
public class ActionItemResource {
    ...
    public ResponseEntity<InputStreamResource> downloadImage(
        ...
        final ActionItemDTO actionItemDTO = actionItemService.get(id);
        return fileDataService.provideDownload(actionItemDTO.getImage());
    }
